// Pre-generated FFI bindings for iOS Simulator ARM64 (aarch64-apple-ios-sim)
// Generated by bindgen 0.69.5 from zenroom.h
//
// These bindings eliminate the need for clang/llvm at build time.
// To regenerate: enable the 'buildtime_bindgen' feature
