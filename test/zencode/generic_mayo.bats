...
and I create the mayo signature of 'message'
Then print the 'message'
and print the 'mayo signature'
EOF
...
Rule check version 2.0.0
Scenario mayo
Given I have a 'mayo public key'
and I have a 'mayo signature'
When I write string 'This is my authenticated message.' in 'message'
and I verify the 'message' has a mayo signature in 'mayo signature' by 'Alice'
...
EOF
    ...
    assert_line --partial 'The mayo signature by Alice is not authentic'
}
...
When I create the mayo signature of 'bigfile'
Then print the 'mayo signature'
EOF
...
and I have a 'mayo signature'
and I have a 'base64' named 'bigfile'
When I verify the 'bigfile' has a mayo signature in 'mayo signature' by 'Alice'
