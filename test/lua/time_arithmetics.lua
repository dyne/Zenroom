...
max  = TIME.new("9223372036854775807")
min = TIME.new("-9223372036854775807")
real_min = TIME.new("-9223372036854775808")
...
assert(max + min  == one, "Error max plus min")
assert(min + max  == one, "Error max plus min")
...
assert_error(function() local r = -real_min end, "fatal time_opposite: Result of opposite out of range")
