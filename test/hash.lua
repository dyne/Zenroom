...
local res
local str448 = str('abcdbcdecdefdefgefghfghighijhijkijkljklmklmnlmnomnopnopq')
...
local str896 = str('abcdefghbcdefghicdefghijdefghijkefghijklfghijklmghijklmnhijklmnoijklmnopjklmnopqklmnopqrlmnopqrsmnopqrstnopqrstu')
