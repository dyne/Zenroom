...
cat << EOF | base64 -w 0 > ../../docs/examples/zencode_cookbook/jsonToBased64.b64
...
cat << EOF > ../../docs/examples/zencode_cookbook/scenarioECDHJSONInBased64.json
{"message": "$(cat ../../docs/examples/zencode_cookbook/jsonToBased64.b64)"}
EOF
...
cat <<EOF  > $tmpData5
{
	...
	"header": "Sample JSON for Bob and Carl"
}
EOF
...
Given that I have a 'base64' named 'message'
...
cat $tmpZencode5 | zexe ../../docs/examples/zencode_cookbook/temp.zen -z -k $tmpData5 -a ../../docs/examples/zencode_cookbook/scenarioECDHJSONInBased64.json | jq . | tee ../../docs/examples/zencode_cookbook/scenarioECDHJSONOutputbase64.json
