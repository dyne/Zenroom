...
All the smart contracts and the data you see in this page are generated by the script [run-when.sh](https://github.com/dyne/Zenroom/blob/master/test/zencode_cookbook/run-when.sh). If you want to run the script (on Linux) you should: 
