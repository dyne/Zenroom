...
with open("./zen1155.sol", "r") as file:
    ...
    compiled_sol = compile_standard(
        {
            "language": "Solidity",
            "sources": {"Inkan1155.sol": {"content": simple_storage_file}},
            "settings": {
                "outputSelection": {
...
# get bytecode
bytecode = compiled_sol["contracts"]["Inkan1155.sol"]["Inkan1155"]["evm"]["bytecode"]["object"]

# get abi
abi = json.loads(compiled_sol["contracts"]["Inkan1155.sol"]["Inkan1155"]["metadata"])["output"]["abi"]
