# lib/niwi Boundary Design

## Principle

lib/niwi is a **standalone library slice** that reuses Longfellow public headers
...
**copied** into lib/niwi/ligero/ with provenance comments and compatibility tests.
...
### Copied into lib/niwi/ligero/ (with provenance)

| Source file | Copied as | Adaptation |
|-------------|-----------|------------|
| lib/longfellow-zk/ligero/[phase files] | lib/niwi/ligero/ | Split monolithic prover into witness-commit, first-challenge, algebraic-response, query-challenge, opening phases |
...
byte-identical proofs before and after lib/niwi is linked. A future
compatibility test runs legacy zkcc tests with lib/niwi linked.
