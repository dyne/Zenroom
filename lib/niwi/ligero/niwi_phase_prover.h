// lib/niwi/ligero/niwi_phase_prover.h
//
...
//
// NiwiPhaseProver wraps Longfellow's LigeroProver and exposes
// the KLP22 phase schedule: commit, derive challenges, respond,
// derive query indices, open.
//
// Each phase boundary allows interposing a NPRO query (random oracle
// observation) for extraction, and KLP22 challenge-share commitments
// are applied before the first verifier challenge.
