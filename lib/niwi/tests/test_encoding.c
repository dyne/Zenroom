/* lib/niwi/tests/test_encoding.c — Vector tests for canonical encoders.
 *
 * Tests byte-exact encoding of primitives, composites, boundary cases,
 * and rejection of overflow/corruption scenarios.
 */
...
int main(void) {
    printf("lib/niwi encoding tests:\n");
