// lib/niwi/tests/test_bench.c
//
// Micro-benchmarks for NIWI primitives ...
//
// These are micro-benchmarks on the scaffolding primitives.
// Full proving/verification benchmarks require the Ligero adaptation
// (milestone 2).
...
int main(void) {
    printf("lib/niwi micro-benchmarks:\n");
    bench_npro_queries();
    bench_hash();
    bench_commitments();
    bench_encoding();
