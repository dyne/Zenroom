/* lib/niwi/tests/test_extract.c — Straight-line extraction tests.
 *
 * Tests the extraction scaffolding:
 *  - Create/free lifecycle
 *  - Proof parse validation (magic, length)
 *  - Gamma deserialization
 *  - Leaf recovery pattern
 *  - Witness recovery stub
 *  - Error code reporting
 *  - Malformed proof rejection
 *  - Missing Gamma rejection
 */
