/* lib/niwi/tests/test_commitment.c — KLP22 and Pass/NPRO commitment tests.
 *
 * Tests:
 *  - Valid commit/open/verify for KLP22
 *  - Mutation of message, randomness, commitment key
 *  - Valid leaf commit/verify
 *  - Missing/NPRO lookup compatibility
 */
