/* lib/niwi/tests/test_abi.c — Exercise the C ABI boundary.
 *
 * This test validates ownership, error reporting, and the absence
 * of exception escapes across the C boundary, using the stub
 * implementation (all ops return "not yet implemented").
 */
