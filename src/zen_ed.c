...
/***
It generates a secret key for the digital signature based on the Elliptic Curve Ed25519.
Does not require an input. 
@function ED.secgen
	@return sk, an octet of 64 byte fixed legth
	@usage
	ED = require("ed")
	...
	--Output: ccc4576e2d62071b972927636a2a2809479d8851cffa5fb485024f2fb4504a01
...
/***
 ...
 @return pk, an octet of 64 byte fixed legth
 @usage
 ED = require("ed")
...
pk = ED.pubgen(sk)
print(pk:hex())			-- print the secret key in hexadecimal notation

--Output: 534f59552d22d6a143d1658d9d956967469c545c37888cc73d59f656cea36566
 */
...
/***
 This function signs a message m using a secret key sk generated by ED.secgen()
 @function ED.sign
 @param sk
 @param m
 @return an octet of 128 byte length, the digital signature
 @usage
ED = require("ed")
...
--Output: 202aa742d4f723a3e27ce359c4383afcb017888e446bc745115ec7559e9a59d14d0f27d10bf3fe32d57fd5802ddb0f5d6eb096e98225fde6ed0ab04d4d5dc101
 */
...
/***
 It verifies if the signature sign of a message m is correct
 @function ED.verify
 @param pk
 @param sign
 @param m
