...
#include <big_383_29.h>
#define big BIG_383_29
#define modbytes MODBYTES_383_29
#define big_zero(b) BIG_383_29_zero(b) 
#define big_fromBytesLen(b,v,l) BIG_383_29_fromBytesLen(b,v,l)
#define big_inc(b,n) BIG_383_29_inc(b,n)
#define big_norm(b) BIG_383_29_norm(b)
#define big_nbits(b) BIG_383_29_nbits(b)
#define big_copy(b,a) BIG_383_29_copy(b,a)
#define big_shr(b,a) BIG_383_29_shr(b,a)
#define big_toBytes(b,a) BIG_383_29_toBytes(b,a)
#elif CHUNK == 16
