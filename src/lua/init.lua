...
--
-- Copyright (C) 2018-2026 Dyne.org foundation designed, written and
...
_G['deterministic_sort'] = QSORT -- explicit deterministic sorter for ordered outputs
table.sort = QSORT -- keep compatibility with existing scripts expecting deterministic sort
SPELL = require('spell')
JSON = require('zenroom_json')
CRYPTO = require('crypto_loader')
