...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = '/home/jrml/devel/decode/zenroom/docs/website/docs/demo/index.data';
        ...
        DataRequest.prototype.byteArray = Module['HEAPU8'].subarray(ptr, ptr+byteArray.length);
          ...
          for (var i = 0; i < files.length; ++i) {
            DataRequest.prototype.requests[files[i].filename].onload();
              ...
              Module['removeRunDependency']('datafile_/home/jrml/devel/decode/zenroom/docs/website/docs/demo/index.data');

    };
    Module['addRunDependency']('datafile_/home/jrml/devel/decode/zenroom/docs/website/docs/demo/index.data');
 ...
 loadPackage({"files": [{"start": 0, "audio": 0, "end": 2521, "filename": "/zenroom_ecdh.lua"}, {"start": 2521, "audio": 0, "end": 3765, "filename": "/zenroom_hash.lua"}, {"start": 3765, "audio": 0, "end": 4407, "filename": "/README.md"}, {"start": 4407, "audio": 0, "end": 4441, "filename": "/zenroom_fp.lua"}, {"start": 4441, "audio": 0, "end": 5428, "filename": "/zenroom_ecp2.lua"}, {"start": 5428, "audio": 0, "end": 12356, "filename": "/zenroom_common.lua"}, {"start": 12356, "audio": 0, "end": 25108, "filename": "/inspect.lua"}, {"start": 25108, "audio": 0, "end": 36574, "filename": "/zencode_coconut.lua"}, {"start": 36574, "audio": 0, "end": 39109, "filename": "/init.lua"}, {"start": 39109, "audio": 0, "end": 43674, "filename": "/zenroom_octet.lua"}, {"start": 43674, "audio": 0, "end": 44921, "filename": "/crypto_elgamal.lua"}, {"start": 44921, "audio": 0, "end": 50506, "filename": "/zencode_ecqv.lua"}, {"start": 50506, "audio": 0, "end": 53357, "filename": "/zenroom_bench.lua"}, {"start": 53357, "audio": 0, "end": 55742, "filename": "/zencode_given.lua"}, {"start": 55742, "audio": 0, "end": 56693, "filename": "/zenroom_ecp.lua"}, {"start": 56693, "audio": 0, "end": 58036, "filename": "/zenroom_cbor.lua"}, {"start": 58036, "audio": 0, "end": 78045, "filename": "/zenroom_table.lua"}, {"start": 78045, "audio": 0, "end": 83645, "filename": "/zencode_simple.lua"}, {"start": 83645, "audio": 0, "end": 98162, "filename": "/cbor.lua"}, {"start": 98162, "audio": 0, "end": 120695, "filename": "/zencode.lua"}, {"start": 120695, "audio": 0, "end": 120732, "filename": "/zenroom_big.lua"}, {"start": 120732, "audio": 0, "end": 133530, "filename": "/crypto_coconut.lua"}, {"start": 133530, "audio": 0, "end": 136477, "filename": "/zenroom_json.lua"}, {"start": 136477, "audio": 0, "end": 139078, "filename": "/zencode_then.lua"}, {"start": 139078, "audio": 0, "end": 145899, "filename": "/semver.lua"}, {"start": 145899, "audio": 0, "end": 146868, "filename": "/zenroom_rng.lua"}, {"start": 146868, "audio": 0, "end": 150631, "filename": "/statemachine.lua"}, {"start": 150631, "audio": 0, "end": 153008, "filename": "/zencode_when.lua"}, {"start": 153008, "audio": 0, "end": 156533, "filename": "/zencode_data.lua"}], "remote_package_size": 156533, "package_uuid": "3dd81303-f39c-4f16-b6a5-8077ec7b7964"});
...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 9528256,
    DYNAMIC_BASE = 9528256,
    DYNAMICTOP_PTR = 4285344;
...
var real__set_debug = asm["_set_debug"]; asm["_set_debug"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
...
var real__zencode_exec = asm["_zencode_exec"]; asm["_zencode_exec"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__zencode_exec.apply(null, arguments);
};

var real__zencode_exec_tobuf = asm["_zencode_exec_tobuf"]; asm["_zencode_exec_tobuf"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__zencode_exec_tobuf.apply(null, arguments);
};

var real__zenroom_exec = asm["_zenroom_exec"]; asm["_zenroom_exec"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__zenroom_exec.apply(null, arguments);
};

var real__zenroom_exec_tobuf = asm["_zenroom_exec_tobuf"]; asm["_zenroom_exec_tobuf"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
...
var _set_debug = Module["_set_debug"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_set_debug"].apply(null, arguments) };
...
var _zencode_exec = Module["_zencode_exec"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_zencode_exec"].apply(null, arguments) };
var _zencode_exec_tobuf = Module["_zencode_exec_tobuf"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_zencode_exec_tobuf"].apply(null, arguments) };
var _zenroom_exec = Module["_zenroom_exec"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_zenroom_exec"].apply(null, arguments) };
var _zenroom_exec_tobuf = Module["_zenroom_exec_tobuf"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_zenroom_exec_tobuf"].apply(null, arguments) };
