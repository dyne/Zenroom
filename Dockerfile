...
RUN mkdir -p /opt/musl-dyne && wget -O musl-dyne.tar.xz "https://files.dyne.org/musl/musl-dyne.tar.xz" && tar -xJf musl-dyne.tar.xz -C /opt/musl-dyne/ --strip-components=1 && rm musl-dyne.tar.xz
